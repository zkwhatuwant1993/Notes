...
- [Java Web高级编程学习笔记：阅读API和JSR等Java EE文档](#java-webapijsrjava-ee)
    ...
    - [九、 使用WebSocket进行通信：全双工通信（服务器推送技术）](#websocket)
        - [10.1 从AJAX到WebSocket](#101-ajaxwebsocket)
            - [10.1.1 问题：从服务器获取的数据什么时候可用](#1011)
            - [10.1.2 解决方案1:轮询](#1012-1)
            - [10.1.3 方案2：长轮询](#1013-2)
            - [10.1.4 方案3:分块编码](#1014-3)
            - [10.1.5 方案4：Applet或者Flash](#1015-4appletflash)
            - [10.1.6 方案5：WebScoket](#1016-5webscoket)
        - [10.2 了解WebSocket API](#102-websocket-api)
...
### 10.1 从AJAX到WebSocket

#### 10.1.1 问题：从服务器获取的数据什么时候可用
